...
def print_text(message, x, y, font_colour = (0, 0, 255),  font_type = 'arial', font_size = 70):
...
def finish(points1, points2):
    ...
    while paused:
        ...
        if keys[pygame.K_ESCAPE]:
            start()
        if points1 == 3:   
            print_text('Player 1 wins', 120, 300)
        if points2 == 3:
            print_text('Player 2 wins', 120, 300)
        pygame.display.update()

...
class Car_road():
    ...
    rects = [pygame.rect.Rect(0, 0, 9, 768), pygame.rect.Rect(10, 0, 1014, 9), pygame.rect.Rect(1015, 10, 9, 758),
             pygame.rect.Rect(10, 757, 1004, 9), pygame.rect.Rect(787, 276, 131, 79), pygame.rect.Rect(465, 10, 18, 163),
             pygame.rect.Rect(339, 446, 677, 18), pygame.rect.Rect(160, 144, 173, 18), pygame.rect.Rect(637, 144, 250, 18),
             pygame.rect.Rect(160, 159, 18, 459), pygame.rect.Rect(178, 306, 461, 18), pygame.rect.Rect(178, 600, 675, 18),
             pygame.rect.Rect(636, 145, 18, 162)
            ]

    def collisiom_handing(self, rects):
        for i in rects:
